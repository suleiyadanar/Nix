//
//  SingleAppReport.swift
//  ReportExtension Nix
//
//  Created by Su Lei Yadanar on 6/27/24.
//
...
extension DeviceActivityReport.Context {
    ...
    // report.
    static let singleAppReport = Self("Single ScreenTime")
}

struct SingleAppReport: DeviceActivityReportScene {
    // Define which context your scene will represent.
    let context: DeviceActivityReport.Context = .singleAppReport
    
    // Define the custom configuration and the resulting view for this report.
    let content: (String) -> SingleAppView
