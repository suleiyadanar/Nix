...
//                                     }
                             ...
                             NewRuleItemView(userId: userId, newItemPresented: $viewModel.showingEditItemView, item:selectedItem)
                            }
...
//
                 ...
                 Button {
                     ...
                     NavigationLink("add stuff", destination: NewRuleItemView(userId: userId, newItemPresented: $viewModel.showingNewItemView))
                     Image(systemName: "calendar")
                     Image(systemName: "gearshape.fill")
                 }.foregroundColor(colorScheme == .dark ? Color.white : Color.black)
             }
             .sheet(isPresented: $viewModel.showingNewItemView){
                 NewRuleItemView(userId: userId, newItemPresented: $viewModel.showingNewItemView)
             }
         }
     }
 }
